...
if (isset($_POST["register"])) {
  ...
  if (mysqli_num_rows($cek) > 0) {
    echo "<script>
      alert('Iahn GPM Sedang Tidak Menilai Kinerja Dosen, Anda Tidak Dapat Mendaftar Akun!');
      document.location.href = 'login2.php';
        </script>";
    // kalau status nya 1 / aktif/sedang menilai kinerja dosen
    // bisa daftar
  } else {
...
<head>
  ...
  <link rel="icon" type="image/png" href="assets1/foto/iahn-bg-tp.png" />
                  ...
                  <div class="p-5">
                    <?php if (isset($error)) : ?>
                        ...
                        <div class="alert">
                          ...
                          <strong>Peringatan!</strong> <br> Username Atau Password Yang Anda Masukkan Salah.
                        </div>
                    <?php endif; ?>
                    <img src="assets1/foto/iahn-bg-tp.png" class="text-center" style="width: 150px; height: 130px; display: block; margin: auto;">
                    <div class="text-center">
                      <p class="text-gray-900 mb-4"><b> Selamat Datang </b> <br> di <br>
                        Website Penilaian Kinerja Dosen Institut Agama Hindu Negeri Gde Pudja Mataram</p>
                    </div>
                    <form class="user">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control mt-1" id="nip" name="nip" autocomplete="off" required minlength="18" maxLength="18">
              </div>
