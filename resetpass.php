...
if (isset($_POST["email"])) {
    ...
    try {
        ...
        $mail->Username   = 'putuananda08@gmail.com';                     // SMTP username
        $mail->Password   = 'hilink_2903';                               // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

        //Recipients
        $mail->setFrom('putuananda@gmail.com', 'Institut Agama Hindu Negeri Gde Pudja Mataram');
        $mail->addAddress("$emailto");     // Add a recipient
        $mail->addReplyTo('no-replyputuananda08@gmail.com', 'No Reply');
