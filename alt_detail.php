          ...
          <div class="col-md-auto">
            <table class="table table-striped">
              <tr>
                ...
                <th class="text-center">Pm_jml</th>
                <th class="text-center">Pm_sbg</th>
                <th class="text-center">penelitian_jml</th>
                <th class="text-center">Jurnal</th>
                <th class="text-center">Absen FP</th>
                <th class="text-center">Absen Apel</th>
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center"><?= $row["pm_jumlah"]; ?></td>
                  <td class="text-center"><?= $row["pm_sbg"]; ?></td>
                  <td class="text-center"><?= $row["penelitian_jml"]; ?></td>
                  <td class="text-center"><?= $row["penelitian_jurnal"]; ?></td>
                  <td class="text-center"><?= $row["absen_fp"]; ?></td>
                  <td class="text-center"><?= $row["absen_apel"]; ?></td>
                  <td class="text-center"><a href="assets1/berkas/<?= $row["Berkas"]; ?>" target="_blank">Lihat<br>Berkas</a></td>
                  <td class="text-center">
                    <?php if ($nt > 0) : ?>
                      <<<<<<< HEAD <a href="nilai_alternatif.php?id_alternatif=<?= $row['id_alternatif'] ?>">Lihat Nilai</a>
                        =======
                  ...
                  <td class="text-center">
                    <?php if ($_SESSION['level'] == 'operator') : ?>
                      <button type="submit" id="verifikasi" class="btn-xs btn-dark" data-toggle="modal" data-target="#modal-xl" data-id="<?= $row['id_alternatif']; ?>">
                      ...
                      <form method="POST">
                        ...
                        <?php $id = $row['id_alternatif'];
                        $ceknilai = query("SELECT*FROM nilai_alt where id_alternatif=$id");
                        if (count($ceknilai) > 0) : ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="perhitungan2.php">
          ...
          <<<<<<< HEAD=======<input type="text" name="periode" value="<?= $id_p ?>">
            >>>>>>> cookie
